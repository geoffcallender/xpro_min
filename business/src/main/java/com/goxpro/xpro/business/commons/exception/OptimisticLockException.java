...
public class OptimisticLockException extends BusinessException {
	 ...
	 *        "com.goxpro.xpro.Department" would be stripped down to "Department") to be used as a message key when generating
	 ...
	 *        com.goxpro.xpro.Department would be stripped down to Department) to be used as a message key when generating a
