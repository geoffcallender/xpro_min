...
public class LockAcquisitionException extends BusinessException {
	...
	/**
	 * This exception is thrown by an IPersistenceExceptionInterpreter when a
	 * org.hibernate.exception.LockAcquisitionException has been detected.
	 * 
	 ...
	 */
	public LockAcquisitionException(Throwable rootCause) {
